...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-lime-300 via-lime-400 to-lime-500 dark:from-lime-600 dark:via-lime-700 dark:to-lime-800"></div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h1 
            ...
            className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-black leading-tight"
          >
            Trusted{' '}
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl mb-8 text-black max-w-2xl mx-auto"
          >
          ...
          >
            ...
            <div className="text-black text-sm font-medium">@williamrey</div>
          </motion.div>
        </div>
      </div>
    </section>
